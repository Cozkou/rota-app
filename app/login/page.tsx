    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 via-pink-100 to-pink-200 p-4">
      <div className="w-full max-w-md bg-white/90 rounded-2xl sm:rounded-3xl shadow-xl sm:shadow-2xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-6">
          ...
          <div>
            <label htmlFor="email" className="block text-sm sm:text-base font-medium text-gray-700 mb-1 sm:mb-2">Email</label>
            <input
              type="email"
              id="email"
              name="email"
              ...
              required
              className="w-full px-3 sm:px-4 py-2 sm:py-3 rounded-lg border-2 border-pink-200 focus:border-pink-400 focus:outline-none text-sm sm:text-base"
              placeholder="Enter your email"
            />
          </div>
          <div>
            <label htmlFor="password" className="block text-sm sm:text-base font-medium text-gray-700 mb-1 sm:mb-2">Password</label>
            <input
